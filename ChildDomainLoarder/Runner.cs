...
namespace ChildDomainLoader
{
    public class Runner : MarshalByRefObject
    {
        public static AppDomain RunInOtherDomain(string assemblyPath)
        {
            ...
            var ownAssemblyName = ownType.Assembly.FullName;
        ...
        public void Run(string assemblyPath)
        {
            ...
            AppDomain.CurrentDomain.AssemblyResolve +=
                (sender, args) =>
                {
                    throw new NotImplementedException(
                        "Probably need to do some work here if you depend on other assemblies.");
                };
            ...
            var main = app.GetMethod("Main", BindingFlags.Static | BindingFlags.Public);
